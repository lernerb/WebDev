...
class validate {
  ...
  * @return void
  */
  public function validateKeyInArr($postVal, $postName, $inArr) {
    if(!isset($inArr[$postVal])) {
  ...
  * @return void
  */
  public function validateDate($postVal, $postName) {
    if(strlen($postVal) < 1) {
      $this->setError($postName, ucfirst($postName)." Please enter a valid date.");
    }
  } 
